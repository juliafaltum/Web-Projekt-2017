            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                if(empty($_SESSION['userid'])) {
                    ...
                    <form method="post" action="login_do.php" class="navbar-form navbar-right" role="search">
                        ...
                        <a data-toggle="tooltip" title="Passwort vergessen?" data-placement="bottom"  href="reset_password.php?vonStartseite=1"> <i style="font-size: 20px; color: white">?</i></a>
                    </form>
...
<?php if(isset($_GET['notification'])) {
    ...
    switch ($notificationType) {
        ...
        case 'newPasswordSuccess':
            ...
            <div class="alert alert-success alert-dismissable fade in">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                <strong>Erfolg!</strong> Ihr gewähltes Passwort ist nun aktiviert! Sie können sich nun einloggen.
            </div>
            <?php
            break;
        ...
        case 'loginFailed':
            ...
            <div class="alert alert-danger alert-dismissable fade in">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                <strong>Fehler!</strong> Die eingegebenen Zugangsdaten sind nicht korrekt.<br>Bitte versuchen Sie es erneut.<br><hr>Passwort vergessen? <a href="reset_password.php?vonStartseite=1">Klicken Sie hier!</a>
            </div>
            <?php
            break;
        ...
        case 'newWelle':
            ...
            <div class="alert alert-success alert-dismissable fade in">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                <strong>Neue Welle veröffentlicht!</strong>
            </div>
            <?php
            break;
